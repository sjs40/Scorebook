...
const labels = {
  ...
  schlittler: "Schlittler's 10 Ks",
  caminero: "Caminero's 455-foot homer",
  chourio: "Chourio's tying homer and Lara walk-off",
...
const nomineeOrder = {
  ...
  "2026-09-08": ["schlittler", "caminero", "chourio", "other"],
};
